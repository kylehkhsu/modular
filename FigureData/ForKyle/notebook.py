...
dropouts = [0, 1]
data_distributions_3 = [np.load(f'WhatWhere/FigureData/ForKyle/data_distribution_dropout_{dropout}.npy') for dropout in dropouts]
activity_data_3 = [np.load(f'WhatWhere/FigureData/ForKyle/responses_dropout_{dropout}.npy', allow_pickle=True) for dropout in dropouts]
