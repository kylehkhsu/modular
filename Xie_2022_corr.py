...
# Set up parameters
repeat = 1 # Whether to include repeats or not
...
num_copies = 2 # How many correlated copies to add
...
# Save config dict
config_dict = {'repeat':repeat, 'reward':reward, 'num_stim':num_stim, 'save_iter':save_iter, 'T':T, 'learning_rate':learning_rate, 'random_seed':random_seed, 'N':N, 'mu_fit':mu_fit, 'mu_G':mu_G, 'mu_W':mu_W, 'mu_R':mu_R, 'mu_pos':mu_pos, 'fit_thresh':fit_thresh, 'debias_outputs':debias_outputs, 'debias_inputs':debias_inputs, 'goal_encoding':goal_encoding, 'num_copies':num_copies}
